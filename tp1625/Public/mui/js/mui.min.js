...
function() {
	...
	function(a, b, c, d, e) {
		var f = "mui-control-item",
			...
			k = "",
			l = function(a, b) {
				return b.classList && (b.classList.contains(f) || b.classList.contains(f)) ? (b.parentNode && b.parentNode.classList && b.parentNode.classList.contains(f) || a.preventDefault(), b) : !1
			};
		a.registerTarget({
			name: d,
			index: 80,
