...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/Public/mui/css/feedback-page.css" />
	</head>
			...
			<div class="mui-page-content">
				<div class="mui-scroll-wrapper">
					<div class="mui-scroll">
						<ul class="mui-table-view mui-table-view-chevron">
							<li class="mui-table-view-cell mui-media">
								<a class="mui-navigate-right" href="#account">
									<img class="mui-media-object mui-pull-left head-img" src="/Public/mui/images/logo.png">
									<div class="mui-media-body">
										<?php echo ($user_name); ?>
										<p class='mui-ellipsis'>vip</p>
									</div>
								</a>
							</li>
						</ul>
						...
						<ul class="mui-table-view mui-table-view-chevron">
							<li class="mui-table-view-cell">
								<a href="#about" class="mui-navigate-right">关于MUI <i class="mui-pull-right update">V3.2.0</i></a>
							</li>
						</ul>
						<ul class="mui-table-view">
							<li style="text-align: center;">
								<?php if($user_name == '访客'): ?><a href="<?php echo U('Index/Login');?>">
									<button type="button" class="mui-btn mui-btn-success mui-btn-block">登陆</button>
									</a>
								<?php else: ?> 
	...
	<script src="/Public/mui/js/mui.view.js "></script>
	<script src='/Public/mui/js/feedback.js'></script>
	<script>
