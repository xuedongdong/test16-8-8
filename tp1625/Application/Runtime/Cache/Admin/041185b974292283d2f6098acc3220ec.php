...
<html class="ui-page-login">
	...
	<body>
		...
		<div class="mui-content">
			<form id='login-form' method="post" action="<?php echo U('Index/doLogin');?>"  class="mui-input-group">
				<div class="mui-input-row">
					<label>账号</label>
					<input id='user_name' name="user_name" type="text" class="mui-input-clear mui-input" placeholder="请输入账号">
				</div>
				<div class="mui-input-row">
					<label>密码</label>
 ...
 -->				<ul class="mui-table-view mui-table-view-chevron">
			...
			<div class="mui-content-padded">
				...
				<div class="link-area"><a href="<?php echo U('Index/Register');?>">注册账号</a> <span class="spliter">|</span> <a id='forgetPassword'>忘记密码</a>
				</div>
		...
		<nav class="mui-bar mui-bar-tab">
			<div>
				...
				<a class="mui-active mui-tab-item" href="<?php echo U('Index/user_center');?>">
