...
<body>
	<center><h1>商品修改页面</h1>
	<div>
		<form action="/index.php/Home/Goods/goodsEdit" method="post">
		<!-- <table class="table table-bordered"> -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商品id：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["goods_id"]); ?>" readonly="readonly" id="goods_id" name="goods_id">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["market_price"]); ?>" placeholder="" id="market_price" name="market_price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商品描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["keywords"]); ?>" placeholder="" id="keywords" name="keywords">
			</div>
		</div>
		<div class="row cl">
