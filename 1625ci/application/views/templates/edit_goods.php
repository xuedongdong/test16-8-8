	...
	<form action="/Goods/edit_goods" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$data.goods_id}" readonly="readonly" placeholder="" id="goods_id" name="goods_id">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$data.goods_name}" placeholder="" id="goods_name" name="goods_name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$data.goods_number}" placeholder="" id="goods_number" name="goods_number">
			</div>
		</div>
		<div class="row cl">
			<div class="formControls col-xs-8 col-sm-9"><span>{$msg}</span>
			</div>
		</div>
...
<script type="text/javascript" src="/public/H-ui/static/h-ui.admin/js/comment.js"></script>
<!--/_footer /作为公共模版分离出去-->
