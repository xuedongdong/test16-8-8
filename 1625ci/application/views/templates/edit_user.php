	...
	<form action="/User/user_edit" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$data.user_id}" readonly="readonly" id="user_id" name="user_id">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$data.birthday}" placeholder="" id="birthday" name="birthday">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">{$msg}</span></label>
		</div>
		<!-- <div class="row cl">
...
<script type="text/javascript" src="/public/H-ui//public/H-ui/static/h-ui/js/H-ui.js"></script> 
