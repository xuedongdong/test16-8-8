<?php
/* Smarty version 3.1.29-dev/5, created on 2016-08-08 16:36:19
  from "D:\phpStudy\WWW\learn\1625ci\application\views\templates\edit_goods.php" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29-dev/5',
  'unifunc' => 'content_57a84483525946_39371698',
  'file_dependency' => 
  array (
    'e25d585e1ca162258f49fc567d214d0f1cacb753' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\learn\\1625ci\\application\\views\\templates\\edit_goods.php',
      1 => 1470645360,
      2 => 'file',
    ),
  ),
...
function content_57a84483525946_39371698 ($_smarty_tpl) {
?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<div class="page-container">
	<form action="/Goods/edit_goods" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品ID：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['goods_id'];?>
" readonly="readonly" placeholder="" id="goods_id" name="goods_id">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['goods_name'];?>
" placeholder="" id="goods_name" name="goods_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['keywords'];?>
" placeholder="" id="keywords" name="keywords">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['goods_number'];?>
" placeholder="" id="goods_number" name="goods_number">
			</div>
		</div>
		<div class="row cl">
			<div class="formControls col-xs-8 col-sm-9"><span><?php echo $_smarty_tpl->tpl_vars['msg']->value;?>
</span>
			</div>
		</div>
...
> 
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/static/h-ui.admin/js/comment.js"><?php echo '</script'; ?>
>
<!--/_footer /作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/lib/webuploader/0.1.5/webuploader.min.js"><?php echo '</script'; ?>
> 
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/lib/ueditor/1.4.3/ueditor.config.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/lib/ueditor/1.4.3/ueditor.all.min.js"> <?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
