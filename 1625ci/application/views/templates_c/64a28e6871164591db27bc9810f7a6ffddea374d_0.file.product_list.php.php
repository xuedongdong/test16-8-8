...
<div style="margin-left:150px;">
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加产品','/Goods/open_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span> <span class="r">共有数据：<strong><?php echo $_smarty_tpl->tpl_vars['count']->value;?>
</strong> 条</span> </div>
		<div class="mt-20">
...
?>
					<tr class="text-c va-m">
						<td><input name="" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['goods_id'];?>
"></td>
						<td><?php echo $_smarty_tpl->tpl_vars['val']->value['goods_id'];?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['val']->value['goods_name'];?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['val']->value['keywords'];?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['val']->value['goods_number'];?>
</td>
...
> 
<?php echo '<script'; ?>
 type="text/javascript" src="/public/H-ui/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"><?php echo '</script'; ?>
> 
<?php echo '<script'; ?>
