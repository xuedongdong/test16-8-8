...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/Welcome/dologin/" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <!-- img src="images/VerifyCode.aspx.png" --> <a id="kanbuq" href="/Welcome/index"><?php echo $image;?>看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
            ...
            使我保持登录状态</label>
            <br>
            <b style="color:red;"><?php echo @$result;?></b>
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
